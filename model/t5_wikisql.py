...
from utils_t5_finetune import format_dataset_wikisql, print_gpu_utilization

# global variables
MODEL_VERSIONS = ["base", "small"]
FINETUNE_PATH = "wikisql"
...
for MODEL_VERSION in MODEL_VERSIONS:
    ...
    train_dataset = train_data.map(
        format_dataset_wikisql, remove_columns=train_data.column_names
    )
    test_dataset = test_data.map(
        format_dataset_wikisql, remove_columns=test_data.column_names
    )
